...
QStringList QUIWidget::showInputBoxs(bool on, bool &ok, QStringList title, QStringList data, int num)
{
    QUIInputBox input;
    input.setParameters(on, title, data, num);
    ok = input.exec();
...
void QUIInputBox::initControl()
{
    ...
    labInfo->setScaledContents(false);
    labInfo->setWordWrap(true);
    labInfo2 = new QLabel(frame);
    labInfo2->setObjectName(QString::fromUtf8("labInfo2"));
    labInfo2->setScaledContents(false);
    labInfo2->setWordWrap(true);
    labInfo3 = new QLabel(frame);
    labInfo3->setObjectName(QString::fromUtf8("labInfo3"));
    labInfo3->setScaledContents(false);
    labInfo3->setWordWrap(true);
    labInfo4 = new QLabel(frame);
    labInfo4->setObjectName(QString::fromUtf8("labInfo4"));
    labInfo4->setScaledContents(false);
    labInfo4->setWordWrap(true);
    labInfo5 = new QLabel(frame);
    labInfo5->setObjectName(QString::fromUtf8("labInfo5"));
    labInfo5->setScaledContents(false);
    labInfo5->setWordWrap(true);
    labInfo6 = new QLabel(frame);
    labInfo6->setObjectName(QString::fromUtf8("labInfo6"));
    labInfo6->setScaledContents(false);
    labInfo6->setWordWrap(true);
    txtValue = new QLineEdit(frame);
    txtValue->setObjectName(QString::fromUtf8("txtValue"));
    txtValue2 = new QLineEdit(frame);
    txtValue2->setObjectName(QString::fromUtf8("txtValue2"));
    txtValue3 = new QLineEdit(frame);
    txtValue3->setObjectName(QString::fromUtf8("txtValue3"));
    txtValue4 = new QLineEdit(frame);
    txtValue4->setObjectName(QString::fromUtf8("txtValue4"));
    txtValue5 = new QLineEdit(frame);
    txtValue5->setObjectName(QString::fromUtf8("txtValue5"));
    txtValue6 = new QLineEdit(frame);
    txtValue6->setObjectName(QString::fromUtf8("txtValue6"));
    verticalLayout3->addWidget(labInfo);
    verticalLayout3->addWidget(txtValue);
    verticalLayout3->addWidget(labInfo2);
    verticalLayout3->addWidget(txtValue2);
    verticalLayout3->addWidget(labInfo3);
    verticalLayout3->addWidget(txtValue3);
    verticalLayout3->addWidget(labInfo4);
    verticalLayout3->addWidget(txtValue4);
    verticalLayout3->addWidget(labInfo5);
    verticalLayout3->addWidget(txtValue5);
    verticalLayout3->addWidget(labInfo6);
    verticalLayout3->addWidget(txtValue6);
//    verticalLayout3->addWidget(labInfo);
//    verticalLayout3->addWidget(txtValue);
...
void QUIInputBox::setParameters(bool on, const QStringList title, QStringList data, int num)
{
    this->closeSec = closeSec;
    this->currentSec = 0;
    this->labTime->clear();
    this->cboxValue->setVisible(false);
    if(num == 2) {
        this->txtValue6->setVisible(false);
        this->labInfo6->setVisible(false);
        this->txtValue5->setVisible(false);
        this->labInfo5->setVisible(false);
        this->txtValue4->setVisible(false);
        this->labInfo4->setVisible(false);
        this->txtValue3->setVisible(false);
        this->labInfo3->setVisible(false);
    } else if(num == 3) {
        this->txtValue6->setVisible(false);
        this->labInfo6->setVisible(false);
        this->txtValue5->setVisible(false);
        ...
        switch (num) {
            case 6:
                this->labInfo6->setText(title[5]);
                if(on) {
                    this->txtValue6->setText(data[5]);
                } else {
                    this->txtValue6->setPlaceholderText(title[5]);
                }
            case 5:
                this->labInfo5->setText(title[4]);
                if(on) {
                    this->txtValue5->setText(data[4]);
                } else {
                    this->txtValue5->setPlaceholderText(title[4]);
                }
            case 4:
                this->labInfo4->setText(title[3]);
                if(on) {
                    this->txtValue4->setText(data[3]);
                } else {
                    this->txtValue4->setPlaceholderText(title[3]);
                }
            case 3:
                this->labInfo3->setText(title[2]);
                if(on) {
                    this->txtValue3->setText(data[2]);
                } else {
                    this->txtValue3->setPlaceholderText(title[2]);
                }
            case 2:
                this->labInfo2->setText(title[1]);
                if(on) {
                    this->txtValue2->setText(data[1]);
                } else {
                    this->txtValue2->setPlaceholderText(title[1]);
                }
            case 1:
                this->labInfo->setText(title[0]);
                if(on) {
                    this->txtValue->setText(data[0]);
                } else {
                    this->txtValue->setPlaceholderText(title[0]);
                }
        }
    }
    checkSec();
...
QStringList QUIInputBox::getValues() const
{
    return this->values;
}
...
void QUIInputBox::on_btnOk_clicked()
{
    ...
    if (this->txtValue->isVisible()) {
        values << this->txtValue->text();
    }
    if (this->txtValue2->isVisible()) {
        values << this->txtValue2->text();
    }
    if (this->txtValue3->isVisible()) {
        values << this->txtValue3->text();
    }
    if (this->txtValue4->isVisible()) {
        values << this->txtValue4->text();
    }
    if (this->txtValue5->isVisible()) {
        values << this->txtValue5->text();
    }
    if (this->txtValue6->isVisible()) {
        values << this->txtValue6->text();
    }
    done(true);
    close();
}
